...
class WrapImage extends StatefulWidget {
    ...
    /// Otherwise, the image dimensions will change as the image is loaded, which
    /// will result in ugly layout changes.
    WrapImage.memory(Uint8List bytes, {
        Key key,
        double scale: 1.0,
        this.width,
        this.height,
...
class _ImageState extends State<WrapImage> {
    ...
    @override
    void didUpdateWidget(WrapImage oldWidget) {
    ...
    void _handleImageChanged(ImageInfo imageInfo, bool synchronousCall) {
        if (widget.imageListener != null) {
            widget.imageListener(imageInfo, synchronousCall);
        }
        setState(() {
